    ...
    pw.Page(
      ...
      build: (ctx) {
        ...
        for (final it in order.orderItems) {
          ...
          final name = pr?.productName ?? 'Unknown';
          ...
          children.add(
            pw.Row(
              ...
              children: [
                pw.Expanded(child: pw.Text('$name ×${_fmtQty(qty)}', size: 11)),
                pw.SizedBox(width: 8),
          ...
          if (disc > 0) {
            children.add(pw.Text('خصم: ${disc.toStringAsFixed(2)}',
        ...
        children.add(
          pw.Row(
            mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
            children: [
              pw.Text('الTotal', size: 12, weight: pw.FontWeight.bold),
        ...
        // Footer
        children.add(pw.Text('شكرًا لزيارتكم',
